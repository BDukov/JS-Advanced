const flowerShop = require('./flowerShop');
 ...
 describe('flowerShop', function (){
    it('calculate price', () => {
        assert.equal(flowerShop.calcPriceOfFlowers('pp', 1, 1),'You need $1.00 to buy pp!');        assert.equal(flowerShop.calcPriceOfFlowers('pp', 1, 1),'You need $1.00 to buy pp!')
    ...
    it('calculate price throws an error', () => {
        ...
        assert.throw(() => flowerShop.calcPriceOfFlowers('pp', 'p', 'p'), 'Invalid input!');
